import BitCoin from '../assets/bitcoin05.svg'
import Hand from '../assets/hand.svg'
import Metaverse from '../assets/metaverse.svg'
import Astroboy from '../assets/astroboy.svg'

import AvatarImg from '../assets/Avatar.png'
import AvatarImgTwo from '../assets/AvatarTwo.svg'

import ImageOne from '../assets/releaseImgOne.svg'
import ImageTwo from '../assets/releaseImageTwo.svg'
import ImageThree from '../assets/releaseImageThree.svg'
import ImageFour from '../assets/releaseImageFour.svg'
import ImageFive from '../assets/releaseImageFive.svg'
import ImageSix from '../assets/releaseImageSix.svg'

import HandImg from '../assets/handImg.svg'
import FlowerImg from '../assets/flowerImg.svg'
import IconRight from '../assets/icons/arrowRightIcon.svg'

import YellowSearch from '../assets/yellowSearch.svg'
import YellowDollar from '../assets/yellowDollar.svg'
import YellowDownload from '../assets/yellowDownload.svg'

export const cryptoCards = [
   {id: 1, Image:BitCoin, text:"DAOs", bgColor:"#000000"},
   {id: 2, Image:Hand, text:"NFTs", bgColor:"#000887"},
   {id: 3, Image:Metaverse, text:"Metaverse", bgColor:"#000000"},
   {id: 4, Image:Astroboy, text:"DeFi", bgColor:"#002114"},
   {id: 5, Image:Astroboy, text:"Smart Contact", bgColor:"#385160"},
]

export const releaseCards = [
   {id:1, image:ImageOne, avatar:AvatarImg, username:"uresiu23", price:"200", cardH2:"Sunrise set megaverse", cardH3:"0.34 Matic"},
   {id:2, image:ImageTwo, avatar:AvatarImg, username:"uresiu23", price:"200", cardH2:"Sunrise set megaverse", cardH3:"0.34 Matic"},
...
export const workCards = [
   {
      id:1,
      cardH2:"Find asset",
      cardP:"Browse assets from the different available categories and find what fit your project(s) perfectly.",
      cardImage:YellowSearch,
   },
   {
      id:2,
      cardH2:"Connect Wallet",
      cardP:"Easily connect your blockchain wallet to our app to pay for your favourite web3 assets.",
      cardImage:YellowDollar,
   },
   {
      id:3,
      cardH2:"Download asset",
      cardP:"Download the required asset(s) in a single click. Assets come in a very high quality form so you need not worry about quality.",
      cardImage:YellowDownload,
   },
]
...
export const networkCards = [
   ...
   },
   {
      ...
      image:ImageTwo, 
      avatar:AvatarImgTwo, 
      username:"comradeglry",
      network:"Motion Designer"
   },
   {
      id: 3,
      image:ImageThree, 
